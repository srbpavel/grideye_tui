...
type ColorPair = (Temperature, ColorRGB);
pub type ColorIndex = Vec<ColorPair>;

//
pub fn temperature_to_color(pallete: &[ColorPair],
                            temperature: Temperature,
) -> Option<ColorRGB> {
    pallete
        .iter()
        .find_map(|(color_temperature, color)| {
            if color_temperature.eq(&temperature) {
                Some(*color)
            } else { None }
        })
}
...
{
    let range = (boundary_max - boundary_min + TEMPERATURE_INDEX_STEP) / PALLETE.len() as Temperature;
    
    PALLETE
        .iter()
        .enumerate()
        .map(|(index, color)| {
            let temperature = (((boundary_min - TEMPERATURE_INDEX_STEP) + (index + 1) as Temperature * range) / TEMPERATURE_INDEX_STEP).ceil() * TEMPERATURE_INDEX_STEP;
...
//pub const IRON_BOW_LONG: [(u8, u8, u8); 433] = [
pub const IRON_BOW_LONG: [(u8, u8, u8); 419] = [
    /* // we disable black
    (0, 0, 10),
    (0, 0, 20),
    (0, 0, 30),
...
/*
pub const PALLETE_RGB: [(u8, u8, u8); 381] = [(0, 0, 128),
    (0, 0, 129),
    (0, 0, 130),
    (0, 0, 131),
    (0, 0, 132),
...
/*
pub const PALLETE_RYGB_SORTED: [(u8, u8, u8); 508] = [(0, 0, 128),
    (0, 0, 129),
    (0, 0, 130),
    (0, 0, 131),
    (0, 0, 132),
...
/*
pub const PALLETE_RYGB: [(u8, u8, u8); 508] = [(0, 0, 128),
    (0, 0, 129),
    (0, 0, 130),
    (0, 0, 131),
    (0, 0, 132),
